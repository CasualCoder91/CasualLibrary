...
\DoxyCodeLine{uintptr\_t address = 0x2240001C;}
...
\end{DoxyCode}
\hypertarget{index_autotoc_md8}{}\doxysubsection{get address from static pointer + offsets}\label{index_autotoc_md8}



\begin{DoxyCode}{0}
\DoxyCodeLine{uintptr\_t baseAddr = memory.getModule(\textcolor{stringliteral}{"ZW64.exe"});}
\DoxyCodeLine{uintptr\_t healthAddr = memory.getAddress(baseAddr+0x00003648, \{ 0x40,0xE4 \});}
\end{DoxyCode}
